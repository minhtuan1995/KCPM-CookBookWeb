    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult FacebookLogin(string token)
        {
           ...
           // client.Encoding = System.Text.Encoding.Unicode;
            ...
            Session["IsNewUser"] = Boolean.FalseString;
            ...
            catch
            {
                ...
                Account account = new Account("cookbookweb", "813114193891114", "wxlTmmFaVu32WCZOSZmHBFiuOd0");
                Cloudinary cloudinary = new Cloudinary(account);

                var uploadParams = new ImageUploadParams()
                {
                    File = new FileDescription(String.Format("https://graph.facebook.com/{0}/picture?width=200&height=200", id))
                };

                var uploadResult = cloudinary.Upload(uploadParams);

                Session["Avatar"] = uploadResult.Uri.AbsoluteUri;
            }
